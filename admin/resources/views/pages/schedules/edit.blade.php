...
@section('content')
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Preencha os campos e clique em atualizar</h3>
        </div>
        <div class="box-body">
            {!! Form::open(['route' =>  ['api.admin.radio.schedules.edit', $schedule], 'method' => 'put' ]) !!}
            ...
            <div class="form-group has-feedback {{ $errors->has('speaker') ? ' has-error' : '' }}">
                ...
                <input type="text"
                       ...
                       id="speaker"
                       name="speaker"
                       value="{{ old('speaker', $schedule['speaker']) }}"
            ...
            <div class="form-group has-feedback {{ $errors->has('image') ? ' has-error' : '' }}">
                ...
                <img id="image-holder" src="{{ old('image', $schedule['image']) }}"
            ...
            <div class="form-group has-feedback {{ $errors->has('thumb') ? ' has-error' : '' }}">
                ...
                <div class="input-group">
                    ...
                    <input id="thumb"
                           value="{{ old('thumb', $schedule['thumb']) }}"
                           readonly
            ...
            <div class="form-group has-feedback {{ $errors->has('description') ? ' has-error' : '' }}">
                ...
                <textarea
                        ...
                        id="description"
                        style="max-width: 100%"
                        placeholder="@lang('Admin::forms.schedules.description.placeholder')">{{ old('description', $schedule['description']) }}</textarea>
