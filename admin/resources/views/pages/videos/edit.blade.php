...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            {!! Form::open(['route' =>  ['api.admin.blog.videos.edit', $video], 'method' => 'put']) !!}
            ...
            <div class="form-group has-feedback {{ $errors->has('thumb') ? ' has-error' : '' }}">
                ...
                <div class="input-group">
                    ...
                    <input id="thumb" value="{{ old('thumb', $video['thumb']) }}" readonly class="form-control lfm-image" type="text"
                           name="thumb" data-input="thumb" data-preview="holder">
                </div>
                <img id="holder" src="{{ old('thumb', $video['thumb']) }}"
            ...
            <div class="form-group has-feedback {{ $errors->has('video') ? ' has-error' : '' }}">
                ...
                <p>
                    <textarea name="video" id="video"
                              class="tinymce-editor">{{ old('video', $video['video']) }}</textarea>
                </p>
                @if ($errors->has('video'))
                    <span class="help-block">
