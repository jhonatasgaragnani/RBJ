...
@section('content')
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">
                Preencha os campos e clique no botão atualizar
            </h3>
        </div>
        <div class="box-body">
            {!! Form::open(['route' => ['api.admin.blog.photos.edit', $photo], 'method' => 'put']) !!}
