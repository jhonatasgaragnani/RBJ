...
@section('content')
    {!! Form::open(['route'=>'api.admin.blog.events.add', 'method' => 'event']) !!}
            ...
            <div class="tab-pane active" id="event">
                ...
                <div class="form-group">
                    ...
                    <textarea name="body" id="body"
                              class="tinymce-editor">{{ old('body', __('Admin::forms.events.body.placeholder')) }}</textarea>
                </div>
                ...
                <div class="form-group has-feedback {{ $errors->has('active') ? ' has-error' : '' }}">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right datepicker" name="happen_at">
                    </div>
            ...
            <div class="tab-pane" id="meta">
                ...
                <div class="form-group has-feedback {{ $errors->has('meta_description') ? ' has-error' : '' }}">
                    ...
                    <textarea name="meta_description"
                              id="meta_description"
                              class="form-control"
                              placeholder="@lang('Admin::forms.events.meta_description.placeholder')">{{ old('meta_description') }}</textarea>
                ...
                <div class="form-group has-feedback {{ $errors->has('meta_keywords') ? ' has-error' : '' }}">
                    ...
                    <textarea name="meta_keywords"
                              id="meta_keywords"
                              class="form-control"
                              placeholder="@lang('Admin::forms.events.meta_keywords.placeholder')">{{ old('meta_keywords') }}</textarea>
