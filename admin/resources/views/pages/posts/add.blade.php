...
@section('content')
    {!! Form::open(['route'=>'api.admin.blog.posts.add', 'method' => 'post']) !!}
            ...
            <div class="tab-pane active" id="post">
                ...
                <div class="form-group has-feedback {{ $errors->has('active') ? ' has-error' : '' }}">
                    ...
                    <select class="select2 form-control" name="active" id="active" style="width: 100%">
                        <option disabled {{ old('active') ?: 'selected' }}>@lang('Admin::forms.posts.active.placeholder')</option>
                        @foreach([[1,'Ativo'], [0, 'Inativo']] as $type)
                            <option value="{{ $type['0'] }}" {{ old('active', '') != '' && old('active') == $type[0] ? 'selected' : '' }}>{{ $type[1] }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group has-feedback {{ $errors->has('type') ? ' has-error' : '' }}">
                    ...
                    <select class="select2 form-control" name="type" id="type" style="width: 100%">
                        <option disabled {{ old('type') ?: 'selected' }}>@lang('Admin::forms.posts.type.placeholder')</option>
                ...
                <div class="form-group">
                    ...
                    <textarea name="body" id="body"
                              class="tinymce-editor">{{ old('body', __('Admin::forms.posts.body.placeholder')) }}</textarea>
                </div>
            ...
            <div class="tab-pane" id="meta">
                ...
                <div class="form-group has-feedback {{ $errors->has('meta_description') ? ' has-error' : '' }}">
                    ...
                    <textarea name="meta_description"
                              id="meta_description"
                              class="form-control"
                              placeholder="@lang('Admin::forms.posts.meta_description.placeholder')">{{ old('meta_description') }}</textarea>
                ...
                <div class="form-group has-feedback {{ $errors->has('meta_keywords') ? ' has-error' : '' }}">
                    ...
                    <textarea name="meta_keywords"
                              id="meta_keywords"
                              class="form-control"
                              placeholder="@lang('Admin::forms.posts.meta_keywords.placeholder')">{{ old('meta_keywords') }}</textarea>
