...
@section('title')
    @lang('Admin::titles.roles.edit', ['name' => $role['name']])
@endsection
...
@section('content')
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Edite as informações e clique no botão salvar</h3>
        </div>
        <div class="box-body">
            {!! Form::open(['route' => ['api.admin.users.roles.edit', $role], 'method' => 'put']) !!}
            ...
            <div class="form-group has-feedback {{ $errors->has('description') ? ' has-error' : '' }}">
                ...
                <input type="text"
                       ...
                       id="description"
                       name="description"
                       value="{{ old('name', $role->description) }}"
