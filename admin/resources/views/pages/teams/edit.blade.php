...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            {!! Form::open(['route' => ['api.admin.radio.teams.update', $team], 'method' => 'put']) !!}
            ...
            <div class="form-group has-feedback {{ $errors->has('image') ? ' has-error' : '' }}">
                ...
                <div class="input-group">
                    ...
                    <input id="image" value="{{ old('image', $team['image']) }}" readonly class="form-control lfm-image" type="text"
                           name="image" data-input="image" data-preview="holder">
                </div>
                <img id="holder" src="{{ old('image', $team['image']) }}"
