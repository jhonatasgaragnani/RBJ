...
@section('title')
    @lang('Admin::titles.partners.edit')
@endsection
...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            {!! Form::open(['route' => ['api.admin.radio.partners.update', $partner], 'method' => 'put']) !!}
            ...
            <div class="form-group has-feedback {{ $errors->has('thumb') ? ' has-error' : '' }}">
                ...
                <div class="input-group">
                    ...
                    <input id="thumb" value="{{ old('thumb', $partner['thumb']) }}" readonly class="form-control lfm-image" type="text"
                           name="thumb" data-input="thumb" data-preview="holder">
                </div>
                <img id="holder" src="{{ old('thumb', $partner['thumb']) }}"
